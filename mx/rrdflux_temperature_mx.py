...
def main(argv):
   ...
   value1="value"
   value2_metric1="TEMP_RE0"
   value2_metric2="TEMP_RE1"
   service="Juniper_Temperature_ACX"
   value4="TEMPERATURE"
   ...
   try:
      opts, args = getopt.getopt(argv,"humf:H:p:d:U:P:k:D:F:L:",["help=","update=","dump=","file=","host=","port=","database=","user=","password=","value=","service=","hostname=","first_time=","last_time=","RRD_MIN_RES="])
...
#         '-r', str(RRD_MIN_RES))
      ...
      while i < len(allvalues[2]):
         ...
         unixts1=(allvalues[0][0]+(i+1)*RRD_MIN_RES)*1000000000
         json_body1.append({
               "measurement": "snmp",
               "time": unixts1,
               "tags": {
